    ...
    return (
        <div className="py-12">
            <img
                src={bannerImage}
                alt="Banner Image"
                className="w-full mx-auto md:mx-w-md"
            />
            <div className="text-center space-y-4">
                ...
                <p className="text gray-500">
                    Best Place to Browse,search,view details,purchase of top flagships
                    phones <br/>
                     of the current time- FlagshipFaceOff
                </p>
                <form
                    action=""
                    className="flex flex-col md:flex-row  justify center items-center ml-50 mb-4 md:px-24"
                >
                    <input
                        type="text"
                        placeholder="Search Phone By name"
                        className="bg-white border border-gray-300 rounded shadow-md 
                    w-2/3 h-12 px-4 mb-3 focus:outline-none focus:
                    shadow-outline md:mr-2 md:mb-0"
                    />
